...
If the value is a mapping, dictionary operations can be performed. In addition, the keys in the mapping can be accessed using object attribute access notation.
